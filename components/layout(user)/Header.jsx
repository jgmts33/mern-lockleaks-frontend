...
import {
  Button, Badge, Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, Input, Navbar, NavbarBrand, NavbarContent, NavbarItem, Link
  ...
  return (
    <Navbar maxWidth="full">
      ...
      <NavbarContent justify="end">
        ...
        <NavbarItem className="text-white items-center">
          <Dropdown>
            <DropdownTrigger>
