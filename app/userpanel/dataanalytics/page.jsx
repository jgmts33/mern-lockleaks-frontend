    ...
    return (
        <div className="flex flex-col bg-gradient-to-tr px-5 py-5 max-sm:py-16 container text-white max-lg:mx-auto">
            ...
            <div className='flex gap-10 max-xl:flex-col max-lg:gap-0'>
                <div className="flex flex-col max-w-[400px] max-xl:mx-auto max-lg:max-w-full w-full bg-white/15 border border-gray-500 rounded-[16px] mt-10 p-10 pb-10 max-sm:mt-5">
                ...
                <div className="flex flex-col max-w-[960px] w-full bg-white/15 border border-gray-500 rounded-[16px] mt-10 px-16 py-10 pb-20 max-md:px-5 max-xl:mt-0 max-lg:mt-5">
