    ...
    return (
        <>
            <div className="flex flex-col bg-gradient-to-tr px-3 py-10 container text-white max-lg:mx-auto ">
                ...
                <div className='flex gap-10 max-lg:flex-col max-lg:gap-3'>
                    <div className="flex flex-col max-w-[460px] max-lg:max-w-full w-full bg-white/15 shadow-sm shadow-gray-50 border border-gray-500 rounded-[16px] mt-5 p-10 pb-5">
                    ...
                    <div className='flex items-center pt-12 max-lg:mx-auto'><span className='text-white font-extrabold text-lg'>Or</span></div>
                    <div className="flex flex-col max-w-[460px] max-lg:max-w-full w-full bg-white/15 shadow-sm shadow-gray-50 border border-gray-500 rounded-[16px] mt-5 p-10 pb-10">
                        <div className='flex max-w-[250px] text-center mx-auto'>
