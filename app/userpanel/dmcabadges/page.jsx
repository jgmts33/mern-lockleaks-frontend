...
export default function DmcaBadges() {
    ...
    return (
        <div className="flex flex-col bg-gradient-to-tr px-5 py-10 container text-white max-lg:mx-auto">
            ...
            <div className='grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-10 max-xl:mx-auto max-xl:justify-center max-xl:items-center max-lg:gap-0'>
                <div className='flex flex-col'>
                    ...
                    <div className='flex justify-between pt-5 max-md:space-y-2'>
                        <div>
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='flex justify-between pt-5 max-md:space-y-2 max-md:space-x-0 w-full'>
                        <div className='flex'>
                            <Button radius="lg" className="bg-gradient-to-tr from-purple-light to-purple-weight border border-gray-500 text-white shadow-lg px-6 py-5 text-base" size='sm'>
                                Download
                            </Button>
