                ...
                <div className='flex flex-col mt-20 max-xl:mt-20 max-w-[1500px] mx-auto w-full max-lg:px-3'>
                    <p className='font-medium text-5xl max-md:text-4xl text-center'>FAQ</p>
                    {
                        CopyrightFAQContent.map((FAQ_content, index) => {
                            return (
                                <div key={index} className='flex mt-10 gap-2 flex-col bg-gradient-to-br from-gray-600/40 to-gray-800/40 rounded-lg p-10 max-sm:p-5 border border-gray-600'>
                                    <div className='flex justify-between'>
                                        <p className='font-medium text-3xl max-md:text-lg'>{FAQ_content.title}</p>
