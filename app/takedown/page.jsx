                ...
                <div className='flex w-full bg-white/5 mx-auto justify-center px-10 py-20 gap-20'>
                    <div className='flex items-center max-w-[870px] justify-between flex-col gap-y-10'>
                        <div className='flex gap-8 p-7'>
                            ...
                            <p className='font-medium text-xl'>Act quickly upon discovering any unauthorized usage of your content to </p>
                        </div>
                ...
                <div className='flex flex-col mt-44 max-w-[1500px] mx-auto mb-56 w-full'>
                    ...
                    <div className='flex mt-20 gap-2 flex-col bg-gradient-to-br from-gray-600/40 to-gray-800/40 rounded-lg p-12 border border-gray-600'>
                        <div className='flex relative'>
                            <p className='font-medium text-4xl'>What is the average turnaround time for content takedowns? </p>
                            <button className="-rotate-[90deg] mt-50 bg-gradient-to-tr from-gray-600/40 to-gray-800/40 mt-0 text-white shadow-full w-10 h-10 flex items-center justify-center rounded-lg  absolute z-50 bottom-[calc(50%-80px)] right-2">
                                {icons.arrowtop}
                            </button>
                        </div>
                    </div>
                    <div className='flex mt-10 gap-2 flex-col bg-gradient-to-br from-gray-600/40 to-gray-800/40 rounded-lg  p-12 border border-gray-600'>
                        <div className='flex justify relative'>
                            <p className='font-medium text-4xl'>WhAre there limitations to takedown actions? </p>
