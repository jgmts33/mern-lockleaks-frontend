...
export default function Details() {
    ...
    return (
        <div className="text-white relative container flex flex-col max-md:px-3 mx-auto" >
            ...
            <div className='max-w-[1242px] mx-auto mt-20 max-md:mt-10'>
                <span>
            ...
            <div className="flex z-10 backdrop-blur-sm bg-white/5 shadow-sm rounded-[20px] w-full flex-col max-md:p-5 gap-4 text-center mt-20 max-md:mt-10">
