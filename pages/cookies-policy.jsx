        ...
        <>
            <div className="flex flex-col mx-auto items-center max-w-[1470px] justify-center text-white w-full font-normal text-base">
                ...
                <div className='mt-5 max-xl:px-3 mb-5 space-y-2'>
                    ...
                    <p>Cookies set by the website owner (in this case, AD BOOST SRL) are called "first-party cookies". Cookies set by parties other than the website owner are called "third-party cookies". Third-party cookies enable third-party features or functionality to be provided on or through the website (e.g., advertising, interactive content, and analytics). The parties that set these third-party cookies can recognize your computer both when it visits the website in question and also when it visits certain other websites.</p>

                    <h2 class="font-medium text-[#F68171]">Why do we use cookies?</h2>
                    <p>We use first and third-party cookies for several reasons. Some cookies are required for technical reasons for our Websites to operate, and we refer to these as "essential" or "strictly necessary" cookies. Other cookies also enable us to track and target the interests of our users to enhance the experience on our Online Properties. Third parties serve cookies through our Websites for advertising, analytics, and other purposes. This is described in more detail below.</p>
                    ...
                    <h2 class="font-medium text-[#F68171]">How can I control cookies?</h2>
                    ...
                    <h2 class="font-medium text-[#F68171]">What about other tracking technologies, like web beacons?</h2>
                    ...
                    <h2 class="font-medium text-[#F68171]">Do you use Flash cookies or Local Shared Objects?</h2>
                    ...
                    <h2 class="font-medium text-[#F68171]">Where can I get further information?</h2>
                    <p>If you have any questions about our use of cookies or other technologies, please email us at <a href="mailto:support@lockleaks.com">support@lockleaks.com</a> or by post to:</p>
                    <p className='notranslate'>AD BOOST S.R.L. <br />
                        Romania, Bacau, Strada Letea 32, Bloc A, Ap. 116, 600343 Romania <br />
                        Phone: +40743798564</p>
                </div>
            </div>
        </>
